...
func (x *CheckResponse) GetApi() string {
	if x != nil {
		return x.Api
	}
	return ""
...
func (x *CheckResponse) GetChecked() int64 {
	if x != nil {
		return x.Checked
	}
	return 0
...
var file_todo_proto_rawDesc = []byte{
	...
	0x22, 0x64, 0x0a, 0x04, 0x54, 0x6f, 0x44, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	...
	0x12, 0x14, 0x0a, 0x05, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x05, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x22, 0x3f, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x74, 0x6f, 0x44, 0x6f, 0x73, 0x22, 0x30, 0x0a, 0x0c, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65,
	...
	0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x3b, 0x0a, 0x0d, 0x43, 0x68, 0x65, 0x63, 0x6b,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x61, 0x70, 0x69, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x61, 0x70, 0x69, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x68,
	0x65, 0x63, 0x6b, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x63, 0x68, 0x65,
	0x63, 0x6b, 0x65, 0x64, 0x32, 0xad, 0x02, 0x0a, 0x0b, 0x54, 0x6f, 0x44, 0x6f, 0x53, 0x65, 0x72,
	...
	0x73, 0x65, 0x12, 0x32, 0x0a, 0x07, 0x52, 0x65, 0x61, 0x64, 0x41, 0x6c, 0x6c, 0x12, 0x12, 0x2e,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2c, 0x0a, 0x05, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x12,
	0x10, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x11, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70,
...
var file_todo_proto_goTypes = []interface{}{
	...
	(*CheckRequest)(nil),    // 11: v1.CheckRequest
	(*CheckResponse)(nil),   // 12: v1.CheckResponse
}
var file_todo_proto_depIdxs = []int32{
	0,  // 0: v1.CreateRequest.toDo:type_name -> v1.ToDo
	0,  // 1: v1.ReadResponse.toDo:type_name -> v1.ToDo
	0,  // 2: v1.UpdateRequest.toDo:type_name -> v1.ToDo
	0,  // 3: v1.ReadAllResponse.toDos:type_name -> v1.ToDo
	1,  // 4: v1.ToDoService.Create:input_type -> v1.CreateRequest
	3,  // 5: v1.ToDoService.Read:input_type -> v1.ReadRequest
	5,  // 6: v1.ToDoService.Update:input_type -> v1.UpdateRequest
	7,  // 7: v1.ToDoService.Delete:input_type -> v1.DeleteRequest
	9,  // 8: v1.ToDoService.ReadAll:input_type -> v1.ReadAllRequest
	11, // 9: v1.ToDoService.Check:input_type -> v1.CheckRequest
	...
	12, // 15: v1.ToDoService.Check:output_type -> v1.CheckResponse
...
func (c *toDoServiceClient) Check(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (*CheckResponse, error) {
	out := new(CheckResponse)
	err := c.cc.Invoke(ctx, "/v1.ToDoService/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// ToDoServiceServer is the grpc API for ToDoService service.
...
func (*UnimplementedToDoServiceServer) Check(context.Context, *CheckRequest) (*CheckResponse, error) {
...
func _ToDoService_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ToDoServiceServer).Check(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.ToDoService/Check",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ToDoServiceServer).Check(ctx, req.(*CheckRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ToDoService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Check",
			Handler:    _ToDoService_Check_Handler,
		},
	},
